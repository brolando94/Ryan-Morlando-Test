...
export class Song extends Component {
    ...
    */
    ...
    deleteClick(Id) {
        ...
        fetch(variables.API_URL + 'song/'+Id, {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
                        ...
                        {songs.map(sng =>
                            <tr key={sng.SongId}>
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        className="btn btn-light mr-1"
                                        onClick={()=>this.deleteClick(sng.SongId)}>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="Modal-body">
                                <div className="input-group mb-3">
                                    <span className="input-group-text">SongName</span>
                                    <input type="text" className="form-control"
                                        value={Name}
                                        onChange={this.changeSongName} />
                                </div>
                                {/* Choices for Album will be a drop down menu coming from the album array*/}
                                <div className="input-group mb-3">
                                    <span className="input-group-text">Album</span>
                                    <select className="form-select"
                                    onChange={this.changeAlbum}
                                        value={Album}>
                                        {albums.map(alb=><option key={alb.AlbumId}>
                                            {alb.AlbumName}
                                        </option>)}
                                    </select>
